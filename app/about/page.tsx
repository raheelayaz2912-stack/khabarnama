...
export default function AboutPage() {
  return (
    <StaticPage title="About Us" urTitle="ہمارے بارے میں">
      <p>
        KHABARX is a bilingual digital publication reporting Pakistan and world news in
      ...
      <p className="font-urdu text-lg" dir="rtl">
        خبر ایکس پاکستان اور دنیا بھر کی خبریں انگریزی اور اردو میں، ایک ہی صفحے پر، شائع کرنے
