...
export default function DisclaimerPage() {
  return (
    <StaticPage title="Disclaimer" urTitle="دستبرداری">
      <p>
        KHABARX reports the news to the best of its ability at the time of publication.
      ...
      <p className="font-urdu text-lg" dir="rtl">
        خبر ایکس اشاعت کے وقت اپنی بہترین صلاحیت کے مطابق خبر شائع کرتا ہے۔ غیر مصدقہ خبروں کو
